...
static int8_t sensor_programming_Init     (void);
static int8_t sensor_programming_DeInit   (void);
static int8_t sensor_programming_Control  (uint8_t cmd, uint8_t* pbuf, uint16_t length);
static int8_t sensor_programming_Receive  (uint8_t* pbuf, uint32_t *Len);

USBD_CDC_ItfTypeDef USBD_CDC_sensor_programming_fops = 
{
  sensor_programming_Init,
  sensor_programming_DeInit,
  sensor_programming_Control,
  sensor_programming_Receive
};
...
/**
  * @brief  sensor_programming_DeInit
...
/**
  * @brief  sensor_programming_Control
...
/**
  * @brief  sensor_programming_Receive
  ...
  * @retval Result of the operation: USBD_OK if all operations are OK else USBD_FAIL
  */
static int8_t sensor_programming_Receive(uint8_t* Buf, uint32_t *Len)
{
